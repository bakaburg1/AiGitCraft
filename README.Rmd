...
## Configuration
AiGitCraft uses the `bakaburg1/llmR` package to interact with Large Language
Models (LLMs).
To interact with LLM through the llmR package you need to set up the necessary
API keys and model identifiers for the language model providers you intend to
use. This can be done by setting the appropriate options in R:
